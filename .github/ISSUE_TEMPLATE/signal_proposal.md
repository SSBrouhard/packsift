...
Describe how the signal can be produced from published tarball bytes, package
metadata, or supported lockfile inputs without model calls or hidden network
lookups.
